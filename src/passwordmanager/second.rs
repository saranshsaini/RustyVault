...
impl PasswordManager {
    pub fn second_screen<T: tui::backend::Backend>(&self, terminal: &mut Terminal<T>) -> PageError {
        ...
        terminal.draw(|rect| {
            ...
            rect.render_widget(self.render_list(), chunks[1])
    ...
    fn render_list<'a>(&self) -> Paragraph<'a> {
